...
const CreateAccountPage = ({ navigation }) => {
  ...
  const validateEntries = async () => {
    ...
    try {
      const response = await axios.post('https://a19e-138-253-184-53.ngrok-free.app/checkEmail', { email: newEmail });
    ...
    if (validated){
      ...
      try {
        const response = await axios.post('https://a19e-138-253-184-53.ngrok-free.app/register', userData);
